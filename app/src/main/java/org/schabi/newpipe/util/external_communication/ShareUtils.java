...
public final class ShareUtils {
     ...
     * <p>
     * This method creates a chooser intent using {@link Intent#createChooser(Intent, CharSequence)}.
     * If the setTitleChooser boolean is true, the string "Open with" will be set as the title of
     * the system chooser.
